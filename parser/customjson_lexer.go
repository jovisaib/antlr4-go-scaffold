...
var customjsonlexerLexerStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	channelNames           []string
	modeNames              []string
...
func customjsonlexerLexerInit() {
	staticData := &customjsonlexerLexerStaticData
...
// CustomJsonLexerInit initializes any static state used to implement CustomJsonLexer. By default the
// static state used to implement the lexer is lazily initialized during the first call to
// NewCustomJsonLexer(). You can call this function if you wish to initialize the static state ahead
// of time.
func CustomJsonLexerInit() {
	staticData := &customjsonlexerLexerStaticData
	staticData.once.Do(customjsonlexerLexerInit)
}

// NewCustomJsonLexer produces a new lexer instance for the optional input antlr.CharStream.
func NewCustomJsonLexer(input antlr.CharStream) *CustomJsonLexer {
	CustomJsonLexerInit()
	l := new(CustomJsonLexer)
	...
	l.GrammarFileName = "CustomJson.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// CustomJsonLexer tokens.
const (
	CustomJsonLexerT__0   = 1
	CustomJsonLexerT__1   = 2
	CustomJsonLexerT__2   = 3
	CustomJsonLexerT__3   = 4
	CustomJsonLexerT__4   = 5
	CustomJsonLexerT__5   = 6
	CustomJsonLexerT__6   = 7
	CustomJsonLexerT__7   = 8
	CustomJsonLexerT__8   = 9
	CustomJsonLexerSTRING = 10
	CustomJsonLexerNUMBER = 11
	CustomJsonLexerWS     = 12
)
