...
var customjsonParserStaticData struct {
	once                   sync.Once
	serializedATN          []int32
	literalNames           []string
...
func customjsonParserInit() {
	staticData := &customjsonParserStaticData
...
// CustomJsonParserInit initializes any static state used to implement CustomJsonParser. By default the
// static state used to implement the parser is lazily initialized during the first call to
// NewCustomJsonParser(). You can call this function if you wish to initialize the static state ahead
// of time.
func CustomJsonParserInit() {
	staticData := &customjsonParserStaticData
	staticData.once.Do(customjsonParserInit)
}

// NewCustomJsonParser produces a new parser instance for the optional input antlr.TokenStream.
func NewCustomJsonParser(input antlr.TokenStream) *CustomJsonParser {
	CustomJsonParserInit()
	this := new(CustomJsonParser)
...
// CustomJsonParser tokens.
const (
	CustomJsonParserEOF    = antlr.TokenEOF
	CustomJsonParserT__0   = 1
	CustomJsonParserT__1   = 2
	CustomJsonParserT__2   = 3
	CustomJsonParserT__3   = 4
	CustomJsonParserT__4   = 5
	CustomJsonParserT__5   = 6
	CustomJsonParserT__6   = 7
	CustomJsonParserT__7   = 8
	CustomJsonParserT__8   = 9
	CustomJsonParserSTRING = 10
	CustomJsonParserNUMBER = 11
	CustomJsonParserWS     = 12
)

// CustomJsonParser rules.
const (
	CustomJsonParserRULE_json  = 0
	CustomJsonParserRULE_obj   = 1
	CustomJsonParserRULE_pair  = 2
	CustomJsonParserRULE_arr   = 3
	CustomJsonParserRULE_value = 4
)
...
func NewEmptyJsonContext() *JsonContext {
	...
	p.RuleIndex = CustomJsonParserRULE_json
	return p
}
...
func (s *JsonContext) EOF() antlr.TerminalNode {
	return s.GetToken(CustomJsonParserEOF, 0)
}
...
func (s *JsonContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(CustomJsonListener); ok {
...
func (p *CustomJsonParser) Json() (localctx IJsonContext) {
	this := p
	_ = this

	localctx = NewJsonContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, CustomJsonParserRULE_json)
...
func NewEmptyObjContext() *ObjContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = CustomJsonParserRULE_obj
	return p
}
...
func (p *CustomJsonParser) Obj() (localctx IObjContext) {
	this := p
	_ = this

	localctx = NewObjContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, CustomJsonParserRULE_obj)
	var _la int
	...
	case 1:
		...
		for _la == CustomJsonParserT__1 {
			{
				p.SetState(15)
				p.Match(CustomJsonParserT__1)
			}
			{
				p.SetState(16)
				p.Pair()
...
func NewEmptyPairContext() *PairContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = CustomJsonParserRULE_pair
	return p
}
...
func (s *PairContext) STRING() antlr.TerminalNode {
	return s.GetToken(CustomJsonParserSTRING, 0)
}
...
func (p *CustomJsonParser) Pair() (localctx IPairContext) {
	this := p
	_ = this

	localctx = NewPairContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 4, CustomJsonParserRULE_pair)
	...
	{
		p.SetState(28)
		p.Match(CustomJsonParserSTRING)
	}
	{
		p.SetState(29)
		p.Match(CustomJsonParserT__3)
	}
	{
		p.SetState(30)
		p.Value()
...
func NewEmptyArrContext() *ArrContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = CustomJsonParserRULE_arr
	return p
}
...
func (p *CustomJsonParser) Arr() (localctx IArrContext) {
	this := p
	_ = this

	localctx = NewArrContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 6, CustomJsonParserRULE_arr)
	var _la int
...
func NewEmptyValueContext() *ValueContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = CustomJsonParserRULE_value
	return p
}
...
func (s *ValueContext) NUMBER() antlr.TerminalNode {
	return s.GetToken(CustomJsonParserNUMBER, 0)
}
...
func (p *CustomJsonParser) Value() (localctx IValueContext) {
	this := p
	_ = this

	localctx = NewValueContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 8, CustomJsonParserRULE_value)
	...
	case CustomJsonParserNUMBER:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(48)
			p.Match(CustomJsonParserNUMBER)
		}

	case CustomJsonParserT__0:
	...
	case CustomJsonParserT__6:
		p.EnterOuterAlt(localctx, 5)
		{
			p.SetState(51)
			p.Match(CustomJsonParserT__6)
		}

	case CustomJsonParserT__7:
		p.EnterOuterAlt(localctx, 6)
		{
			p.SetState(52)
			p.Match(CustomJsonParserT__7)
		}

	case CustomJsonParserT__8:
		p.EnterOuterAlt(localctx, 7)
		{
			p.SetState(53)
			p.Match(CustomJsonParserT__8)
		}
